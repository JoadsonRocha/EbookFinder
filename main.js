...
function normalizarModeloIA(m) {
  if (!m) return "openai/gpt-oss-20b";
  if (m.includes("120b")) return "openai/gpt-oss-120b";
  if (m.includes("20b")) return "openai/gpt-oss-20b";
  if (m.includes("llama")) return "openai/gpt-oss-20b";
  return m;
}
